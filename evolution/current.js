...
function render(){
 ...
 $('#stage-explanation').textContent=study.view_id==='metal1'?'Metal27 reaches its best retained Max EPE at candidate 2. Candidates 6 and 7 test local feedback and both worsen the maximum. Two later proposals repeat already measured recipes, triggering the frozen stopping rule.':'This trajectory stays global and stops after two consecutive proposals recreate already measured recipes. The extra budget alone does not produce sustained local refinement.';
 renderGeometry();
}
